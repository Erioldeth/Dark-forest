...
void loadMedia() {
	...
	setting.setButtonSize(BUTTON_WIDTH * 3 / 2, BUTTON_HEIGHT);
	...
	normal_mode.setButtonSize(BUTTON_WIDTH * 3 / 2, BUTTON_HEIGHT);
	...
	player.setEntityAnimation(JUMP, 0, 96 + 32, 336 + 40, 32, 44);
